            ...
            <div class="box box-primary">
                ...
                <form action="{{ route('admin.user.store') }} " method="POST" enctype="multipart/form-data"> 
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="name" name="name" value="{{ old('name') }}"  class="form-control  {{ $errors->has('name') ? 'has-error is-invalid' : '' }}"placeholder="Enter Nmae">
                        @error('name')
                     ...
                     <div class="form-group">
                        ...
                        <input type="email" id="email" name="email" value="{{ old('email') }}"  class="form-control  {{ $errors->has('email') ? 'has-error is-invalid' : '' }}"placeholder="Enter Email">
                        @error('email')
                            <span class="error invalid-feedback" style="color:red;">{{$message}}</span>
                        @enderror
                     </div>  
                     ...
                     <div class="form-group">
                        ...
                        <input type="password" id="password" name="password" value="{{ old('password') }}"  class="form-control  {{ $errors->has('password') ? 'has-error is-invalid' : '' }}"placeholder="Enter Password">
                        @error('password')
                            <span class="error invalid-feedback" style="color:red;">{{$message}}</span>
                        @enderror
                     </div>       
