        ...
        <section class="content">
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <form action="{{ route('admin.targeted_group.update',$targeted_group->id) }}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control {{ $errors->has('title') ? 'has-error is-invalid' : ''  }}" name="title" placeholder="Place Enter Targeted Group" id="title_for" value="{{ old('title',$targeted_group->title) }}">
                             @error('title')
