        ...
        <section class="content">
            ...
            <div class="box box-primary">
                ...
                <div class="box-header with-border">
                    <div class="col-md-4">
                      <a href="{{ route('admin.project.create') }}" class="btn btn-primary"><i class="fa fa-plus"></i> @lang('site.add')</a>
                    </div>
                        ...
                        <table class="table table-hover">
                            ...
                            @foreach ($projects as $index=>$project)
                                <tr>
                                    ...
                                    <td>{{ $project->title }}</td>
                                    <td>
                                      <a href="{{ route('admin.project.edit', $project->id) }}" class="btn btn-info btn-sm"><i class="fa fa-edit"></i> @lang('site.edit')</a>
