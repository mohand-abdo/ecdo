                ...
                <div class="box-body">
                    ...
                    <form action="{{ route('admin.project.update',$project->id) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control {{ $errors->has('title') ? 'has-error is-invalid' : ''  }}" name="title" placeholder="Place Enter Title" id="title_for" value="{{ old('title',$project->title) }}">
                             @error('title')
                         ...
                         <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="file" name="images[]" multiple class="form-control {{ $errors->has('image') ? 'has-error is-invalid' : '' }}" id="images" >
                                <div id="preview-container" style="margin-top: 10px;">
                                    @if($project->images->count() > 0)
                                        @foreach($project->images as $image)
                                            <img id="default-image" src="{{ asset('images/project/'.$image->image) }} " alt="Default Image" style="width: 150px; height: 150px; object-fit: cover; border: 1px solid #ddd; border-radius: 5px;">
                                        @endforeach
                                    @else
