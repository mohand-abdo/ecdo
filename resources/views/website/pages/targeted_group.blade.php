    ...
    @if($targeted_groups->count() > 0)
        <div class="container" style="margin-top: 140px">
            <section class="content">
                ...
                <div class="text">
                    <h2>Targeted <span>Groups</span></h2>
                    <hr>
                    <ul>
                        @foreach($targeted_groups as $targeted_group )
                            <li><i class="fas fa-check colored-icon"></i>{{ $targeted_group->title }}</li>
                        @endforeach
                    </ul>
                </div>
            </section>
