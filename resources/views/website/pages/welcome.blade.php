...
@push('style')
    <style>
        ...
        .home-up__container::after,.featured-two-up .fc-two-up__item-secondary span::before{
            background-color: #2ecc71;
        }

        a::before,.pillars-six__bar{
            background-color: #2ecc71;
        }
        ...
        @media only screen and (min-width: 576px) {
            .latest-news__title,.home-up__subtitle{
                border-bottom: 0;            }
        }
        ...
        <div class="container">
            ...
            <div class="hero-home__wrapper">
                ...
                <img loading="lazy" class="hero-home__image hero-home__image"
                     ...
                     srcset="{{ asset('images/indro/'.$indro->image) }}"
                     alt="{{ $indro->title }}">
                ...
                <div class="hero-home__content hero-home__content--left" style="margin-top: 100px">
...
<section class="latest-news">
  <div class="container container--medium">
        ...
        <div class="latest-news__wrap latest-news__wrap--md">
          <a href="{{ route('story.show',$story->id) }}">
            ...
            <div class="latest-news__content latest-news__content--md">
              ...
              <a class="latest-news__link-desktop" href="{{ route('story.show',$story->id) }}">Read More</a>
            </div>
          </a>
        </div>
        @endforeach
    ...
    <div class="latest-news__wrap">
      <div class="latest-news__background" style="background-image: url('{{ asset("images/story/".$story->image) }}');"></div>

      <div class="latest-news__content">
        <a class="latest-news__link-mobile" href="{{ route('story.show',$story->id) }}">{{ $story->title }}</a>
      </div>
    </div>
    @endforeach
...
<section class="home-up">
  <div class="container container--md">
    <div class="home-up__wrapper">
      ...
      <p class="home-up__subtitle home-up__subtitle--md">From advocacy, to donating money, volunteering and more, there are many ways you can help.</p>
    </div>

    <div class="home-up__container">
      @foreach($helps as $help)
        <div class="home-up__wrap home-up__wrap--md">
          <div class="home-up__background home-up__background--md" style="background-image: url('{{ asset("images/help/".$help->image) }}');">
          </div>
...
<div class="container">
  ...
  <p class="home-up__subtitle">From advocacy, to donating money, volunteering and more, there are many ways you can help.</p>
@foreach($helps as $help)
  <div class="home-up__wrap">
    <div class="home-up__background" style="background-image: url('{{ asset("images/help/".$help->image) }}');">
    </div>
...
@foreach($humanitarians as $humanitarian)
  <article class="fc-two-up__item fc-two-up__item-secondary">
    <a href="{{ route('story.show',$humanitarian->id) }}" target="">
      ...
      <div class="fc-two-up__item-image"  style="background-image: url('{{ asset("images/story/".$humanitarian->image) }}');"  data-aos="fade-down" data-aos-delay="50" data-aos-duration="1000" data-aos-once="true"></div>
    </a>
  </article>
@endforeach
</section>
...
<div class="pillars-six__bar pillars-six__bar--transition" id="pillars-six__bar-1883277136"  role="presentation"></div>
...
<section data-pillarid="146298135" class="pillars-six" id="pillars-six-146298135">
  ...
  <div class="pillars-six__items pillars-six__items--white">
    ...
    <div class="container">
      <div class="pillars-six__items-content">
        ...
        <h3>ECDO tackles poverty from multiple angles. See how we focus our efforts in the fight against poverty.</h3>
      </div>
    </div>

    <div class="pillars-six__wrap">
      <div class="pillars-six__item"
      data-aos="fade-up" data-aos-delay="300" data-aos-easing="linear"
      data-aos-offset="0"
      data-aos-once="true">
      <a href="#">
        <div class="pillars-six__item-image" style="background: url('{{ asset("images/poverty/p1.jpg") }}') !important;">
  ...
  <div class="pillars-six__item"
  data-aos="fade-up" data-aos-delay="600" data-aos-easing="linear"
  data-aos-offset="-100"
  data-aos-once="true">
  <a href="#">
...
<div class="pillars-six__item"
data-aos="fade-up" data-aos-delay="900" data-aos-easing="linear"
data-aos-offset="0"
data-aos-once="true">
<a href="#">
  <div class="pillars-six__item-image" style="background: url('{{ asset("images/poverty/p3.jpg") }}') center center no-repeat !important;">
  <div class="pillars-six__content-area">
...
<div class="pillars-six__item"
data-aos="fade-up" data-aos-delay="1200" data-aos-easing="linear"
data-aos-offset="-100"
data-aos-once="true">
<a href="#">
  <div class="pillars-six__item-image" style="background: url('{{ asset("images/poverty/p4.jpg") }}') center center no-repeat !important;"
  >
  <div class="pillars-six__content-area">
...
<div class="pillars-six__item"
data-aos="fade-up" data-aos-delay="1500" data-aos-easing="linear"
data-aos-offset="0"
data-aos-once="true">
<a href="#">
  <div class="pillars-six__item-image" style="background: url('{{ asset("images/poverty/p5.jpg") }}') center center no-repeat !important;">
  <div class="pillars-six__content-area">
...
<div class="pillars-six__item"
data-aos="fade-up" data-aos-delay="1800" data-aos-easing="linear"
data-aos-offset="-100"
data-aos-once="true">
<a href="#">
  <div class="pillars-six__item-image"
...
<div class="preload">
  <img loading="lazy" width="15" height="15" src="{{ asset('assets/themes/careorg/assets/img/icon-callout/icon-disaster-response-fill.svg') }}" alt="icon">
  <img loading="lazy" width="15" height="15" src="{{ asset('assets/themes/careorg/assets/img/icon-callout/icon-food-nutrition-fill.svg') }}" alt="icon">
  <img loading="lazy" width="15" height="15" src="{{ asset('assets/themes/careorg/assets/img/icon-callout/icon-health-fill.svg') }}" alt="icon">
  <img loading="lazy" width="15" height="15" src="{{ asset('assets/themes/careorg/assets/img/icon-callout/icon-education-work-fill.svg') }}" alt="icon">
  <img loading="lazy" width="15" height="15" src="{{ asset('assets/themes/careorg/assets/img/icon-callout/icon-climate-fill.svg') }}" alt="icon">
  <img loading="lazy" width="15" height="15" src="{{ asset('assets/themes/careorg/assets/img/icon-callout/icon-equality-fill.svg') }}" alt="icon">
</div>
</section>
...
<style>
    ...
    .pillars-six__item:hover {
        transform: translateY(-10px); /* يجعل العنصر يرتفع قليلاً عند التحويم */
    ...
    .pillars-six__item:hover .pillars-six__item-image {
        background-size: 110%; /* تكبير الصورة قليلاً عند التحويم */
    }
    .pillars-six__icon {
