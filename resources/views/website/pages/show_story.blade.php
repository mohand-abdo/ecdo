...
@push('style')
    <style>
        ...
        .body-text__content ol a,
        .body-text__content p a,
        .body-text__content ul a {
            box-shadow: inset 0 -2px 0 #2ecc71;
        }

        .body-text__content ol a:hover,
        .body-text__content p a:hover,
        .body-text__content ul a:hover {
        ...
        .three-up__link-md::before,
        .three-up__content a::before {
            background: #2ecc71;
        }

        .three-up__link-md:hover::before,
        .three-up__content a:hover::before {
            background: #2ecc71;
        }
    ...
    <section class="body-photo ">
        <div class="container">
            <div class="body-photo__content body-photo__content--column " data-aos="fade-up" data-aos-once="true"
                ...
                @else
                    <img id="currentMedia" src="{{ asset('images/story/' . $story->image) }}" alt="{{ $story->title }}"
                ...
                <div class="two-col-list__list">
                    @foreach ($resources as $resource)
                        <div class="two-col-list__item">
                            ...
                            <div class="two-col-list__image"
                                style="background-image:url({{ asset('images/resource/' . $resource->image) }})"></div>
                        </div>
                    @endforeach
                </div>
            </div>
                    ...
                    @foreach ($stories as $story)
                        <div class="three-up__wrap">
                            ...
                            <div class="three-up__content">
                                ...
                                <p class="three-up__preview">{!! Str::limit(strip_tags($story->body), 50, '...') !!}<a
                                        href="{{ route('story.show', $story->id) }}" class="read-more">Read More</a></p>
